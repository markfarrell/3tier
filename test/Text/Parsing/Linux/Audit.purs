...
examples =
  ...
  {-- USER-AUTH --}
  , "type=USER_AUTH msg=audit(1576087608.595:122): pid=1643 uid=0 auid=4294967295 ses=4294967295 msg='op=PAM:authentication grantors=pam_permit acct=\"gdm\" exe=\"/usr/libexec/gdm-session-worker\" hostname=isec2077-vm02 addr=? terminal=/dev/tty1 res=success'"
  {-- USER-ACCT --}
  , "type=USER_ACCT msg=audit(1576087608.595:123): pid=1643 uid=0 auid=4294967295 ses=4294967295 msg='op=PAM:accounting grantors=pam_permit acct=\"gdm\" exe=\"/usr/libexec/gdm-session-worker\" hostname=isec2077-vm02 addr=? terminal=/dev/tty1 res=success'"
  {-- CRED-ACQ --}
  , "type=CRED_ACQ msg=audit(1576087608.598:124): pid=1643 uid=0 auid=4294967295 ses=4294967295 msg='op=PAM:setcred grantors=pam_permit acct=\"gdm\" exe=\"/usr/libexec/gdm-session-worker\" hostname=isec2077-vm02 addr=? terminal=/dev/tty1 res=success'"
  {-- CRED-DISP --}
